...
# read signature data
sig_df <- read_signature_data("up-sig-file.grp", "down-sig-file.grp")
...
transformed_se <- transform(data_se)

up_genes_df <- sig_df[sig_df$Symbols.representing.expression == 1, ]
down_genes_df <- sig_df[sig_df$Symbols.representing.expression == -1, ]
