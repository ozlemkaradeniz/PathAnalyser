...
#' optional features. It should be called after classification method to evaluate accuracy of classification
#' @author Ozlem Karadeniz \email{ozlem.karadeniz.283@cranfield.ac.uk}
#' @param true_labels_source  data frame ,matrix or name of file which contains sample Ids and corresponding actual labels.
#' @param predicted_labels_source predicted labels data frame or matrix generated by classification method
#' @param pathway name of pathway, currently HER2 and ER are defined.
#' @param display_statistics optional flag to display statistical information about confusion matrix
...
calculate_accuracy <-function(true_labels_source, predicted_labels_source, pathway,
  ...
  # true_labels_source is checked if it is data frame or matrix
